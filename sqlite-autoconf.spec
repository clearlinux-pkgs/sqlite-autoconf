...
Version  : 3270100
Release  : 67
URL      : http://sqlite.org/2019/sqlite-autoconf-3270100.tar.gz
Source0  : http://sqlite.org/2019/sqlite-autoconf-3270100.tar.gz
...
%prep
%setup -q -n sqlite-autoconf-3270100
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
%patch5 -p1
pushd ..
cp -a sqlite-autoconf-3270100 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1550190357
export AR=gcc-ar
