...
Source0  : https://sqlite.org/2021/sqlite-autoconf-3350400.tar.gz
...
%prep
%setup -q -n sqlite-autoconf-3350400
cd %{_builddir}/sqlite-autoconf-3350400
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
%patch5 -p1
pushd ..
cp -a sqlite-autoconf-3350400 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617405706
