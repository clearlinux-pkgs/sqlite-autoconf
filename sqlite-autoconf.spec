...
Source0  : http://sqlite.org/2017/sqlite-autoconf-3190300.tar.gz
...
%prep
%setup -q -n sqlite-autoconf-3190300
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
%patch5 -p1
pushd ..
cp -a sqlite-autoconf-3190300 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1497048474
export AR=gcc-ar
