...
Version  : 3250200
Release  : 64
URL      : http://sqlite.org/2018/sqlite-autoconf-3250200.tar.gz
Source0  : http://sqlite.org/2018/sqlite-autoconf-3250200.tar.gz
...
%prep
%setup -q -n sqlite-autoconf-3250200
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
%patch5 -p1
pushd ..
cp -a sqlite-autoconf-3250200 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1537973644
export AR=gcc-ar
