...
Source0  : https://sqlite.org/2024/sqlite-autoconf-3460000.tar.gz
...
%prep
%setup -q -n sqlite-autoconf-3460000
cd %{_builddir}/sqlite-autoconf-3460000
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
pushd ..
cp -a sqlite-autoconf-3460000 build32
popd
pushd ..
cp -a sqlite-autoconf-3460000 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720032495
