...
Version  : 3260000
Release  : 66
URL      : http://sqlite.org/2018/sqlite-autoconf-3260000.tar.gz
Source0  : http://sqlite.org/2018/sqlite-autoconf-3260000.tar.gz
...
%prep
%setup -q -n sqlite-autoconf-3260000
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
%patch5 -p1
pushd ..
cp -a sqlite-autoconf-3260000 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1543767351
export AR=gcc-ar
