...
Source0  : https://sqlite.org/2020/sqlite-autoconf-3310100.tar.gz
...
%prep
%setup -q -n sqlite-autoconf-3310100
cd %{_builddir}/sqlite-autoconf-3310100
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
%patch6 -p1
pushd ..
cp -a sqlite-autoconf-3310100 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582334549
