...
Version  : 3250300
Release  : 65
URL      : http://sqlite.org/2018/sqlite-autoconf-3250300.tar.gz
Source0  : http://sqlite.org/2018/sqlite-autoconf-3250300.tar.gz
...
%prep
%setup -q -n sqlite-autoconf-3250300
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
%patch5 -p1
pushd ..
cp -a sqlite-autoconf-3250300 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1541545743
export AR=gcc-ar
