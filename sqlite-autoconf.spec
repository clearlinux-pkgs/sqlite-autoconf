...
Source0  : https://sqlite.org/2023/sqlite-autoconf-3410100.tar.gz
...
%prep
%setup -q -n sqlite-autoconf-3410100
cd %{_builddir}/sqlite-autoconf-3410100
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
pushd ..
cp -a sqlite-autoconf-3410100 build32
popd
