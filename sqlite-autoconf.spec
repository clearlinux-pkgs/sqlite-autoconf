...
Version  : 3.35.1
Release  : 95
URL      : https://sqlite.org/2021/sqlite-autoconf-3350100.tar.gz
Source0  : https://sqlite.org/2021/sqlite-autoconf-3350100.tar.gz
...
%prep
%setup -q -n sqlite-autoconf-3350100
cd %{_builddir}/sqlite-autoconf-3350100
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
%patch5 -p1
pushd ..
cp -a sqlite-autoconf-3350100 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615846329
