...
Source0  : https://sqlite.org/2019/sqlite-autoconf-3280000.tar.gz
...
%prep
%setup -q -n sqlite-autoconf-3280000
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
%patch5 -p1
pushd ..
cp -a sqlite-autoconf-3280000 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1555894086
export AR=gcc-ar
